...
!function (t, e) {
  ...
  return i = {}, r.m = n = [function (t, e, n) {
    ...
    var d,
      p = (d = c.MDCFoundation, r(h, d), Object.defineProperty(h, "strings", {
        get: function () {
          return u.strings;
        },
        enumerable: !1,
    ...
    var o,
      ...
      l = (o = s.MDCComponent, r(d, o), Object.defineProperty(d.prototype, "vertical", {
        ...
        var e,
          n = t.querySelector("." + this.classNameMap[c.cssClasses.LIST_ITEM_PRIMARY_TEXT_CLASS]);
    ...
    var h,
      f = (h = u.MDCFoundation, r(y, h), Object.defineProperty(y, "strings", {
        get: function () {
          return T.strings;
        },
        enumerable: !1,
        ...
        if (this.adapter.isRootFocused()) {
          ...
          if (!(-1 === g && (g = n) < 0)) {
            if (h && C([])) b.preventDefaultEvent(t), this.focusNextElement(g);else if (f && C([])) b.preventDefaultEvent(t), this.focusPrevElement(g);else if (h && C(["Shift"]) && this.isCheckboxList) b.preventDefaultEvent(t), -1 !== (_ = this.focusNextElement(g)) && this.setSelectedIndexOnAction(_, !1);else if (f && C(["Shift"]) && this.isCheckboxList) {
              var _;
              b.preventDefaultEvent(t), -1 !== (_ = this.focusPrevElement(g)) && this.setSelectedIndexOnAction(_, !1);
            } else if (u && C([])) b.preventDefaultEvent(t), this.focusFirstElement();else if (l && C([])) b.preventDefaultEvent(t), this.focusLastElement();else if (u && C(["Control", "Shift"]) && this.isCheckboxList) {
            ...
            } else if (y && C(["Control"]) && this.isCheckboxList) t.preventDefault(), this.checkboxListToggleAll(this.selectedIndex === T.numbers.UNSET_INDEX ? [] : this.selectedIndex, !0);else if ((d || p) && C([])) {
              if (e) {
    ...
    var d,
      p = (d = u.MDCFoundation, r(h, d), Object.defineProperty(h, "cssClasses", {
        get: function () {
          return l.cssClasses;
        },
        enumerable: !1,
    ...
    var l,
      d = (r(p, l = c), p.prototype.init = function () {
    ...
    var l,
      d = (l = s.MDCFoundation, r(p, l), Object.defineProperty(p, "strings", {
        get: function () {
          return u.strings;
        },
        enumerable: !1,
        ...
        if (void 0 !== e) if (this.isActivationKey(e) || t.preventDefault(), this.useAutomaticActivation) {
    ...
    var g,
      ...
      m = (g = c.MDCFoundation, r(v, g), Object.defineProperty(v, "defaultAdapter", {
        ...
        var i = n.caretWidth,
          ...
          f = o ? p : d,
          y = s - e / 2;
        return new Map([[b.XPositionWithCaret.START, h], [b.XPositionWithCaret.CENTER, y], [b.XPositionWithCaret.END, f], [b.XPositionWithCaret.SIDE_END, l], [b.XPositionWithCaret.SIDE_START, u]]);
        ...
        return new Map([[b.YPositionWithCaret.ABOVE, a], [b.YPositionWithCaret.BELOW, s], [b.YPositionWithCaret.SIDE_TOP, c], [b.YPositionWithCaret.SIDE_CENTER, u], [b.YPositionWithCaret.SIDE_BOTTOM, l]]);
    ...
    var o,
      ...
      _ = (o = a.MDCComponent, r(m, o), m.attachTo = function (t) {
        ...
        for (var e = 0; e < this.chips.length; e++) if (this.chipsList[e].id === t) return e;
        return -1;
      }, m);
    function m() {
      return null !== o && o.apply(this, arguments) || this;
    ...
    var r = (o.getInstance = function () {
      ...
      var n,
        i,
        r = null !== (n = null == e ? void 0 : e.priority) && void 0 !== n ? n : c.POLITE,
    ...
    var s,
      ...
      h = (s = a.MDCComponent, r(f, s), f.attachTo = function (t) {
        ...
        if (e) {
          ...
          -1 !== i && this.foundation.handleSortAction({
            columnId: n,
            columnIndex: i,
            headerCell: e
          });
    ...
    var s,
      ...
      f = (s = a.MDCComponent, r(y, s), y.attachTo = function (t) {
        ...
        for (var t = 0; t < this.tabList.length; t++) if (this.tabList[t].active) {
        ...
        var n = this,
          t = {
            ...
            getPreviousActiveTabIndex: function () {
              for (var t = 0; t < n.tabList.length; t++) if (n.tabList[t].active) return t;
              return -1;
            },
            getFocusedTabIndex: function () {
            ...
            getIndexOfTabById: function (t) {
              for (var e = 0; e < n.tabList.length; e++) if (n.tabList[e].id === t) return e;
              return -1;
            },
            getTabListLength: function () {
